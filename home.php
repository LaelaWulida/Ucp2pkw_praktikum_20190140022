...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container">
        <a class="navbar-brand" href="#">Daftar Buku Toko Ceria</a>
                        ...
                        <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control" id="diskon" placeholder="Masukkan Probabilitas Diskon" name="diskon" required></textarea>
                                </div>
                            </div>
    ...
    <div class="container mt-5">
      ...
      <tbody>
          ...
          include 'config.php';
          $no = 1;
          $listbuku = mysqli_query($koneksi, "select * from listbuku");
          while ($data = mysqli_fetch_array($listbuku)){
            ?>
              <tr>
                  <td><?php echo $no++; ?> </td>
